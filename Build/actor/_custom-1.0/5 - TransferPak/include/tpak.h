 ...
 */
typedef struct gameboy_cartridge_header
{
 ...
 * @return 0 if successful or @ref TPAK_ERROR otherwise.
 */
int tpak_get_cartridge_header(OSMesgQueue* serialEventQueue, int controller, struct gameboy_cartridge_header* header);
 ...
 */
bool tpak_check_header(OSMesgQueue* serialEventQueue, int controller, gameboy_cartridge_header* header);
